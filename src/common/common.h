...
#define INNER_COMMUNICATOR_TYPE "INNER_COMMUNICATOR_TYPE"
#define INNER_REDUCTION_TYPE "INNER_REDUCTION_TYPE"
#define CROSS_REDUCTION_TYPE "CROSS_REDUCTION_TYPE"
#define REMOTE_BUF_COMPRESSION "REMOTE_BUF_COMPRESSION"
#define DEBUG_ALL_TO_ALL_REDUCTION "DEBUG_ALL_TO_ALL_REDUCTION"
