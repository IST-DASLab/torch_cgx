...
- `CGX_INNER_COMMUNICATOR_TYPE `. Specifies what library to use as communication backend (MPI or SHM). SHM shows better performance but is limited to a single node.
